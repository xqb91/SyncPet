...
public class AdminEspecies extends javax.swing.JFrame {
    ...
    public void rellenarTabla() {
        ...
        for(Especie ta : new EspecieJpaController(emf).findEspecieEntities()) {
            Object[] obj = new Object[2];
            obj[0] = ta.getIdEspecie();
            obj[1] = ta.getNombre();
            modelo.addRow(obj);
        }
    ...
    private void tablaResultadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaResultadosMouseClicked
        if(tablaResultados.getSelectedColumn() >= 0) {
            ...
            e = new EspecieJpaController(emf).findEspecie(Integer.parseInt(String.valueOf(modelo.getValueAt(tablaResultados.getSelectedRow(), 0))));
            ...
            if(e == null) {
                ...
                txtFamilia.setText(e.getFamilia());
    ...
    private void txtNombreKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreKeyTyped
        if(txtNombre.getText().length() > 38) {
            evt.consume();
        }
    ...
    private void btnAccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccionActionPerformed
        if(btnAccion.getText().compareToIgnoreCase("guardar") == 0) {
            ...
            if(txtNombre.getText().isEmpty()){
                JOptionPane.showMessageDialog(null, "El campo de nombre de especie se encuentra vacío");
                txtNombre.requestFocus();
            }else{
                if(txtFamilia.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(null, "La familia de la especie se encuentra vacía");
                    txtNombre.requestFocus();  
                }else{
                    try {
                        EspecieJpaController tjc = new EspecieJpaController(emf);
                        if(!tjc.existeTipoAlergia(txtNombre.getText())) {
                            tjc.create(new Especie(tjc.ultimo(), txtNombre.getText(), txtFamilia.getText()));
                            JOptionPane.showMessageDialog(null, "Especie registrada con éxito");
                            btnCancelarActionPerformed(evt);
                        }else{
                            JOptionPane.showMessageDialog(null, "Especie ya se encuentra registrada");
                            txtNombre.setText("");
                            txtNombre.requestFocus();
                        }
                    } catch (Exception e) {
                        JOptionPane.showMessageDialog(null, "Ocurrió un problema al intentar registrar la especie: "+e.getMessage());
                    }
                }
            }
        }else{
            ...
            if(txtNombre.getText().isEmpty()){
                ...
                try {
                    EspecieJpaController tjc = new EspecieJpaController(emf);
                    tjc.actualizar(new Especie(e.getIdEspecie(), txtNombre.getText(), txtFamilia.getText()));
                    JOptionPane.showMessageDialog(null, "Especie actualizada con éxito");
                    btnCancelarActionPerformed(evt);
                    e = null;
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "Ocurrió un problema al intentar actualizar especie: "+e.getMessage());
                }
            }
        }
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        if(tablaResultados.getSelectedColumn() >= 0) {
            ...
            e = new EspecieJpaController(emf).findEspecie(Integer.parseInt(String.valueOf(modelo.getValueAt(tablaResultados.getSelectedRow(), 0))));
            //si el tipo de alergia no fue encontrado
            int opcion = JOptionPane.showConfirmDialog(null, "¿Esta seguro de eliminar la especie seleccionada?");
            if(opcion == 0) {
                //se informa que el pais no fue encontrado
                try {
                    new EspecieJpaController(emf).destroy(e.getIdEspecie());
                    JOptionPane.showMessageDialog(null, "Eliminada");
                    btnCancelarActionPerformed(evt);
                }catch(Exception e) {
                    JOptionPane.showMessageDialog(null, "Ocurrió un error al intentar eliminar la especie");
                }
            }else{
                btnCancelarActionPerformed(evt);
            }
    ...
    private void txtFamiliaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFamiliaKeyTyped
        if(txtNombre.getText().length() > 48) {
            evt.consume();
        }
